...
# User Define Function to return country of origin
country_udf=udf(lambda x: immigration_codes[x],StringType())

# User Define Function to return State
state_udf=udf(lambda x: state_abbrev[x],StringType())
abbrev_state_udf=udf(lambda x: abbrev_state[x],StringType())


# User Define Function to return state 
city_code_udf=udf(lambda x:i94_port[x].rsplit()[0])
state_code_udf=udf(lambda x:i94_port[x].rsplit()[1])

# User Define Function to return arriving model
arr_udf= udf(lambda x:i94_model[x], StringType())

# User Define Function to return visa type
visa_udf= udf(lambda x:i94_visa[x], StringType())